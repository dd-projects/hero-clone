 ...
 * 
 * @Autowired NDUSActiveDirectoryLdapAuthenticationProvider adProvider;
 * 
 * @Override protected void configure(HttpSecurity http) throws Exception { http
 * .authorizeRequests() .antMatchers("/api/hello**").permitAll()
 * .antMatchers("/**").hasRole("USER") .and() .formLogin(); }
 * 
 * @Bean public NDUSActiveDirectoryLdapAuthenticationProvider
 * adAuthenticationProvider() { NDUSActiveDirectoryLdapAuthenticationProvider
 * adLdap = new NDUSActiveDirectoryLdapAuthenticationProvider( "ad.ndus.edu",
 * "ldaps://NDUSDC1.ad.ndus.edu:636" );
 * adLdap.setConvertSubErrorCodesToExceptions(true); return adLdap; }
 * 
 * @Override
 * 
